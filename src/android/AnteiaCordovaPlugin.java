...
public class AnteiaCordovaPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        switch (action) {
            ...
            case "launchBiometrics":
                ...
                return true;
            case "executeLists":
                String regId5 = args.getString(0);
                this.executeLists(regId5, callbackContext);
                return true;
            case "getRegistration":
                String regId6 = args.getString(0);
                this.getRegistration(regId6, callbackContext);
                return true;
    ...
    public void executeLists(String regId, CallbackContext call) {
        if (!isInitialized) {
            call.error("ERROR: SDK Not Initialized!");
            return;
        }
        ...
        try {
            sdk.executeLists(s -> {
                ...
                try {
                    ...
                    e.printStackTrace();
                    call.error("Error inesperado");
                    return null;
                } catch (Exception e) {
                    call.error("Error: No se ha inicializado el plugin");
                    return null;
                }
    ...
    public void getRegistration(String regId, CallbackContext call) {
        if (!isInitialized) {
            call.error("ERROR: SDK Not Initialized!");
            return;
        }
